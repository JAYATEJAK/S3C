...
def get_command_line_parser():
    ...
    parser.add_argument('-not_data_init_new', action='store_true', help='using average data embedding to init or not')
    ...
    parser.add_argument('--Method', default="Random", type=str, \
                    help='Method Folder Which contains checkpoints')
    ...
    parser.add_argument('-lr_semantic', type=float, default=0.1) #lr for semantic network
